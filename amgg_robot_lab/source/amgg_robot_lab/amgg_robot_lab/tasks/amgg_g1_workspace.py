...
AMGG_G1_TASK_LAYOUTS: dict[str, dict[str, tuple[float, float, float]]] = {
    ...
    "bimanual_reorient": {
        "object": (0.00, 0.26, 1.035),
        "left_support": (-0.18, 0.34, 1.055),
        "right_support": (0.18, 0.34, 1.055),
        "goal": (0.00, 0.34, 1.115),
        "goal_marker": (0.00, 0.34, 1.115),
    },
    "precision_insert": {
        "object": (-0.16, 0.26, 1.070),
        "guide_left": (0.118, 0.320, 1.055),
        "guide_right": (0.202, 0.320, 1.055),
